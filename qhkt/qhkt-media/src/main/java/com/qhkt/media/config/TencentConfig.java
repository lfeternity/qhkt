...
import com.qhkt.media.storage.tencent.TencentFileStorage;
import com.qhkt.media.storage.tencent.TencentMediaStorage;
...
public class TencentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "qhkt.platform", name = "media", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "qhkt.platform", name = "file", havingValue = "TENCENT")
