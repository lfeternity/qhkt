...
public class QhktTemporalConverter extends TemporalAccessorConverter {
    public QhktTemporalConverter(Class<?> targetType) {
        super(targetType);
    }

    public QhktTemporalConverter(Class<?> targetType, String format) {
