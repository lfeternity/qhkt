package com.qhkt.common.autoconfigure.swagger;

import cn.hutool.core.convert.ConverterRegistry;
import com.fasterxml.classmate.TypeResolver;
import com.qhkt.common.domain.R;
import com.qhkt.common.utils.QhktTemporalConverter;
...
@Configuration
@ConditionalOnProperty(prefix = "qhkt.swagger", name = "enable",havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(prefix = "qhkt.swagger", name = "enableResponseWrap",havingValue = "true")
    ...
    }
    {
        ...
        converterRegistry.putCustom(LocalDateTime.class, new QhktTemporalConverter(LocalDateTime.class));
    }
}