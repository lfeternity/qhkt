# 启航课堂 - 启航课堂
#### 项目简介
> 由学成在线项目升级 为启航课堂 主要包含课程录播、销售（优惠券）、评论、笔记、等相关功能实现。升级之后包含用户端和管理后台两个部分
#### 技术栈应用
...
#### 访问地址
- 用户端 
    - 测试地址一：http://172.17.2.134/qhkt-test 松松（自己申请服务器部署）项目结束释放
    - 测试地址二：https://qhkt-user-t.itheima.net 运维部署
- 管理后台
    - 测试地址一：http://172.17.2.134/qhkt-admin-test
    - 测试地址二：https://qhkt-admin-t.itheima.net 运维部署
