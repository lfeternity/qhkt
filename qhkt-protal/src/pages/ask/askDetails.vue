        ...
        <div class="fx-sb ">
          <div class="fx-1 marg-rt-20">
            ...
            <div class="answerCont bg-wt marg-bt-20">
              ...
              <div class="answer fx">
                <img :src="store.getUserInfo?.icon || '/src/assets/anonymity.png'" alt="" srcset="">
                <div class="fx-1">
          ...
          <RelatedQuestions
            :id="askInfo.courseId || route.query.detailsId"
            :current-id="askInfo.id"
    ...
    <el-dialog v-model="dialogTableVisible" :title="`全部回复(${replyCont})`" width="80%" top="5vh" >
      <div class="dialogReplyCont" v-infinite-scroll="load" style="overflow: auto" :infinite-scroll-disabled="disabled">
        ...
        <!-- 回复列表 -->
         ...
         <p class="fx-ct ft-14 ft-cl-des" v-if="replyLoding">Loading...</p>
...
watch(() => route.query.id, (id, previousId) => {
  if (!id || id === previousId) {
    return
  }
  askInfo.value = null
  questParams.questionId = id
  questParams.pageNo = 1
  questionData.value = []
  replyData.value = []
  openReplyFormId.value = undefined
  isReplay.value = undefined
  answerInfo.value = { id: '' }
  targetInfo.value = { id: '' }
  replyParams.pageNo = 1
  replyParams.answerId = ''
  replyCont.value = 0
