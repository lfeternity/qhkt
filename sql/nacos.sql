...
INSERT INTO `config_info` VALUES (2, 'shared-mybatis.yaml', 'DEFAULT_GROUP', 'mybatis-plus:\r\n  configuration:\r\n    default-enum-type-handler: com.baomidou.mybatisplus.core.handlers.MybatisEnumTypeHandler\r\n  global-config:\r\n    field-strategy: 0\r\n    db-config:\r\n      logic-delete-field: deleted\r\n      id-type: assign_id\r\nspring:\r\n  datasource:\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://${qhkt.jdbc.host:192.168.150.101}:${qhkt.jdbc.port:3306}/${qhkt.jdbc.database}?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&serverTimezone=Asia/Shanghai\r\n    username: ${qhkt.jdbc.username:root}\r\n    password: ${qhkt.jdbc.password:123}', '4b1ab0646c41bea2fc1cd2311257ea46', '2023-04-13 05:55:18', '2023-04-13 05:55:18', NULL, '172.17.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (3, 'shared-mq.yaml', 'DEFAULT_GROUP', 'spring:\n  rabbitmq:\n    host: ${qhkt.mq.host:192.168.150.101}\n    port: ${qhkt.mq.port:5672}\n    virtual-host: ${qhkt.mq.vhost:/qhkt}\n    username: ${qhkt.mq.username:qhkt}\n    password: ${qhkt.mq.password:123321}\n    listener:\n      simple:\n        retry:\n          enabled: ${qhkt.mq.listener.retry.enable:true} # 开启消费者失败重试\n          initial-interval: ${qhkt.mq.listener.retry.interval:1000ms} # 初始的失败等待时长为1秒\n          multiplier: ${qhkt.mq.listener.retry.multiplier:2} # 失败的等待时长倍数，下次等待时长 = multiplier * last-interval\n          max-attempts: ${qhkt.mq.listener.retry.max-attempts:3} # 最大重试次数\n          stateless: ${qhkt.mq.listener.retry.stateless:true} # true无状态；false有状态。如果业务中包含事务，这里改为false', '0f9a19bbcec3c267eee1140911e1177a', '2023-04-13 05:55:18', '2023-04-13 05:55:18', NULL, '172.17.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (4, 'shared-redis.yaml', 'DEFAULT_GROUP', 'spring:\n  redis:\n    host: ${qhkt.redis.host:192.168.150.101}\n    password: ${qhkt.redis.password:123321}\n    lettuce:\n      pool:\n        max-active: ${qhkt.redis.pool.max-active:8}\n        max-idle: ${qhkt.redis.pool.max-idle:8}\n        min-idle: ${qhkt.redis.pool.min-idle:1}\n        max-wait: ${qhkt.redis.pool.max-wait:300}', 'e716bf4ae9da1cc93d83ae24f91e89b8', '2023-04-13 05:55:18', '2023-04-13 05:55:18', NULL, '172.17.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
...
INSERT INTO `config_info` VALUES (12, 'trade-service.yaml', 'DEFAULT_GROUP', 'qhkt:\n  carts:\n    maxCourseAmount: 9', '30934042971b3fd8db12a64b920d2d26', '2023-04-13 05:55:18', '2023-04-13 05:56:39', 'nacos', '172.17.0.1', '', '', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (13, 'shared-sentinel.yaml', 'DEFAULT_GROUP', 'seata:\r\n  registry: # TC服务注册中心的配置，微服务根据这些信息去注册中心获取tc服务地址\r\n    type: nacos # 注册中心类型 nacos\r\n    nacos:\r\n      server-addr: 127.0.0.1:8848 # nacos地址\r\n      namespace: \"c975b6f4-de7e-40ad-9b15-4a245ce7a2ef\" # namespace，默认为空\r\n      group: DEFAULT_GROUP # 分组，默认是DEFAULT_GROUP\r\n      application: seata-server # seata服务名称\r\n      username: nacos\r\n      password: nacos\r\n  tx-service-group: qhkt # 事务组名称\r\n  service:\r\n    vgroup-mapping: # 事务组与cluster的映射关系\r\n      qhkt: DEFAULT', 'a562467ae2dc1b12cfff32896350badf', '2023-04-13 05:55:18', '2023-04-13 05:55:18', NULL, '172.17.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (14, 'shared-seata.yaml', 'DEFAULT_GROUP', 'seata:\n  registry: # TC服务注册中心的配置，微服务根据这些信息去注册中心获取tc服务地址\n    type: nacos # 注册中心类型 nacos\n    nacos:\n      server-addr: 192.168.150.101:8848 # nacos地址\n      namespace: \"c975b6f4-de7e-40ad-9b15-4a245ce7a2ef\" # namespace，默认为空\n      group: DEFAULT_GROUP # 分组，默认是DEFAULT_GROUP\n      application: seata-server # seata服务名称\n      username: nacos\n      password: nacos\n  tx-service-group: qhkt # 事务组名称\n  service:\n    vgroup-mapping: # 事务组与cluster的映射关系\n      qhkt: \"default\"', '26a4cdc57695d1d88eae16537231f9ba', '2023-04-13 05:55:18', '2023-04-13 05:55:18', NULL, '172.17.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (15, 'pay-service.yaml', 'DEFAULT_GROUP', 'qhkt:\n  pay:\n    notifyHost: https://624613b8.cpolar.cn/ps', 'bd0a251f6159d992c0092011d76bb923', '2023-04-13 05:55:18', '2023-04-13 05:55:18', NULL, '172.17.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (16, 'shared-mongo.yaml', 'DEFAULT_GROUP', 'spring:\r\n  data:\r\n    mongodb:\r\n      uri: mongodb://${qhkt.mongo.username:qhkt}:${qhkt.mongo.password:123}@${qhkt.mongo.ip:192.168.150.101}:${qhkt.mongo.port:27017}/${qhkt.mongo.database:exam}', '8cd56aa01b50ddddca61dcfd64d6f25e', '2023-04-13 05:55:18', '2023-04-13 05:55:18', NULL, '172.17.0.1', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
...
-- ----------------------------
INSERT INTO `tenant_info` VALUES (1, '1', 'f923fb34-cb0a-4c06-8fca-ad61ea61a3f0', 'qhkt-dev', '开发环境', 'nacos', 1681383294095, 1681383294095);
INSERT INTO `tenant_info` VALUES (2, '1', '0b28cd9d-6c25-4aeb-8607-80a3c0361484', 'qhkt-test', '测试环境', 'nacos', 1681383303639, 1681383303639);
